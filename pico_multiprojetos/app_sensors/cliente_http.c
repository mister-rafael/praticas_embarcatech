...
//#define HOST "pico-server-web-bgkq.vercel.app" // Nome do host do servidor web VERCEL
//#define PORT 80         // Porta do servidor web
#define HOST "pico-server-web.onrender.com" // Nome do host do servidor web RENDER.COM
